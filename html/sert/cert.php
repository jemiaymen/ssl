                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form role='form' method='post' >
                                                <fieldset>
                                                    <input type='hidden' name='id' value="<?php if(isset($_GET['rem'])) echo $_GET['rem']; ?>" >
                                                    <div class='form-group'>
                                                        <input class='form-control' placeholder='Cause de Refus' name='comm' type='text' required>
                                                    </div>
                                                    <button type='submit' class='btn btn-lg btn-danger btn-block' >Valider</button>
                                                </fieldset>
                                            </form>
                                        </div>
